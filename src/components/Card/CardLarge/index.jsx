...
const CardLarge = ({path, banner, titleRecipe, created , children})=>{
    return(
        <div className={container}>
            ...
            <div className='flex-grow-1'>
                ...
                <span className={`d-block mt-2 ${created_at}`}>created at <span className="text_highlight ms-1 fw-bold">{created}</span></span>
                {children}
            </div>
        </div>
    )
